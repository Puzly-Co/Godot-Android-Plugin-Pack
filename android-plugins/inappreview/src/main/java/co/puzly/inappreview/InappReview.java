 ...
 */
public class InappReview extends GodotPlugin {
    private static final String CLASS_NAME = InappReview.class.getSimpleName();
    ...
    public InappReview(Godot godot) {
        super(godot);
    }
